...
__title__ = "FreeCAD FEM material orthotropic task panel for the document object"
__author__ = "Bernd Hahnebach, Tim Swait"
__url__ = "https://www.freecad.org"

## @package task_material_ortho
#  \ingroup FEM
#  \brief task panel for orthotopic material object
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    """
    The editmode TaskPanel for MaterialOrtho objects
    """
